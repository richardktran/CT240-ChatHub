                    ...
                    <div className="nk-block pt-5 nk-auth-body">
                        <div className="brand-logo pb-5 mt-5">
                            <a href="#" className="logo-link">
                                <img className="logo-light logo-img logo-img-lg" src="./images/logo1.jpg" srcSet="./images/logo2x.png 2x" alt="logo" />
                                <img className="logo-dark logo-img logo-img-lg" src="./images/logo1.jpg" srcSet="./images/logo1.jpg 2x" alt="logo-dark" />
                            </a>
                        </div>
